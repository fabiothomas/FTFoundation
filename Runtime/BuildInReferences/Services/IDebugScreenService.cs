...
namespace FTFoundation.BuildInReferences
{
  ...
  public interface IDebugScreenService
  {
    ...
    /// <summary>
    /// Adds a value watcher to the debug screen for the specified saveable value. The value watcher will be removed when the returned IDisposable is disposed.
    /// </summary>
    /// <typeparam name="T">The type of the saveable value.</typeparam>
    /// <param name="label">The text to display for the value watcher.</param>
    /// <param name="saveable">The saveable value to watch.</param>
    /// <param name="color">The color of the value watcher. If null, a default color will be used.</param>
    /// <returns>An IDisposable that can be disposed to remove the value watcher from the debug screen.</returns>
